...
export const movies = [
    ...
    // 💡 FINAL FIX: Add War of the Worlds for Tom Cruise
    { id: 23, title: "War of the Worlds", time: 116, genres: ["Sci-Fi", "Thriller"], director: "Steven Spielberg", actors: ["Tom Cruise"] }
];

// The derived actors and directors arrays will automatically update and should now be correct.
export const actors = [
